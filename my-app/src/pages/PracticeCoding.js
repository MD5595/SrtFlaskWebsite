  ...
  return (
    <div className="container">
      <h1><a href="https://www.programiz.com/python-programming/online-compiler/"
        ...
        1) Make a program that contains 4 variables. There should be a int, float, string, and true
            <br/> <br/>
...
1) Create a list that contains one value of each datatype.<br/>
            2) Create a list that contains 4 values. Have the 3rd index of the list be printed.<br/>
