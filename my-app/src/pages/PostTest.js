...
<p>You can expand the boxes of the free response coding questions.</p><br/>
            <form onSubmit={handleSubmit}>
                ...
                <label htmlFor="answer22">22. Which variable name is valid?
                    <br/>
                    <select id="answer22">
                ...
                <br/><br/>
                {/* Question 23 */}
                <label htmlFor="answer23">23. Write a program that receives an amount of cents ranging from 1 to 100
                    from a
                    user,
                ...
                <label htmlFor="answer24">24. Which value could be picked by random.randint(20,49)

                    <br/>
                    <select id="answer24">
                        <option value="a">5/10</option>
                        <option value="b">48.5</option>
                        <option value="c">49</option>
